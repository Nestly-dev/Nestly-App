...
const hotelAuthService_1 = require("../services/hotelAuthService");
const authMiddleware_1 = require("../middleware/authMiddleware");
const Router = express_1.default.Router();
const hotelAuthService = new hotelAuthService_1.HotelAuthenticationService();
/**
 ...
 */
Router.post('/set-password', authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
