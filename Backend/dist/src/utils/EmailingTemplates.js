...
exports.emailingOptions = void 0;
class EmailingOptions {
    forgotPassword(firstname, OTP) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    temporaryHotelAdminLoginPassword(username, password) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    clientComplains(name, email, hotelName, subject, message) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    customerInvitationTemplate(data) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    hotelManagerInvitationTemplate(data, hotelName) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    viaAdminInvitationTemplate(data) {
        return `
<!DOCTYPE html>
<html lang="en">
<head>
...
`;
    ...
    softwareGlitchReport(name, email, userRole, issueDescription, severity) {
        return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
...
exports.emailingOptions = new EmailingOptions();
